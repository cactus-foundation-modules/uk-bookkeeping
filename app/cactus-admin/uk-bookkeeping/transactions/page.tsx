...
import TransactionsScreen from '@/modules/uk-bookkeeping/components/admin/TransactionsScreen'
...
export default async function BookkeepingTransactionsPage() {
  ...
  return (
    <div>
      ...
      <TransactionsScreen environment={settings.hmrc_environment} canRecord={access.canRecord} />
    </div>
  )
}
