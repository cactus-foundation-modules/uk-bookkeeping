...
import ImportScreen from '@/modules/uk-bookkeeping/components/admin/ImportScreen'

export const metadata = { title: 'Import a bank statement — Admin' }

export default async function BookkeepingImportPage() {
  ...
  return (
    <div>
      ...
      <ImportScreen environment={settings.hmrc_environment} canRecord={access.canRecord} />
    </div>
  )
}
